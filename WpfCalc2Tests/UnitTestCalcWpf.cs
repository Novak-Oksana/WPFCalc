...
namespace UnitTestProjectCalc_WF
{
    ...
    public class UnitTestCalcWpf
    {
        ...
        {
            Application application = Application.Launch(@"E:\work\Calculator\WpfCalc2\WpfCalc2\bin\Debug\WpfCalc2.exe");
            ...
            window.Get<Button>(SearchCriteria.ByAutomationId("btnequal")).Click();
